...
public class BluetoothService {
    ...
    private void addBondDevicesToListView() {
        ...
        System.out.println("bonded number: " + count);
    ...
    private void addUnbondDevicesToListView() {
        ...
        System.out.println("unbonded number: " + count);
        for (int i = 0; i < count; i++) {
            HashMap<String, Object> map = new HashMap<String, Object>();
                ...
                .setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> arg0, View arg1,
                        ...
                        try {
                            ...
                            Toast.makeText(context, "failed pairing！", Toast.LENGTH_SHORT)
                                    .show();
                        }
    ...
    public void addUnbondDevices(BluetoothDevice device) {
        System.out.println("unbonded device name：" + device.getName());
    ...
    public void addBandDevices(BluetoothDevice device) {
        System.out.println("bonded device name：" + device.getName());
